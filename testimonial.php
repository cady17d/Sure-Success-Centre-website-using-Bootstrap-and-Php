      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="Navbar">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="#"><span class="fa fa-comments fa-lg"></span> Testimonial</a></li>
...
<div class="row row-header row-content">
    ...
    <?php       
            ...
            <li class="media">
            <div class="media-body bg-<?php echo $color ?> text-<?php echo $textcolor ?>">
            <hr style="border:dashed thin;">
            <?php 
                  
                  echo "Date: ".$jsontxt[$cnt]["date"]." ";
                  echo "Time: ".$jsontxt[$cnt]["time"]."<br>";
                  echo "Name: ".$jsontxt[$cnt]["name"]."<br>";
                  echo "Comment: ".$jsontxt[$cnt]["comment"]."<br>";
